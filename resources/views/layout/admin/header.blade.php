              ...
              <div class="app-utilities col-auto">
                      ...
                      <div class="item p-3">
                        ...
                        >
                          <div class="col-auto">
                            <img
                              class="profile-image"
                              src="{{asset('backOffice/assets/images/profiles/profile-1.png')}}"
                              alt=""
                            />
                          </div>
                          <!--//col-->
                      ...
                      <div class="item p-3">
                        ...
                        >
                          <div class="col-auto">
                            <img
                              class="profile-image"
                              src="{{asset('backOffice/assets/images/profiles/profile-2.png')}}"
                              alt=""
                            />
                          </div>
                          <!--//col-->
                          <div class="col">
                            <div class="info">
                              <div class="desc">
                                James enviou uma mensagem.
                              </div>
                              <div class="meta">7 dias atras</div>
                            </div>
                          </div>
                          <!--//col-->
                        </div>
                ...
                <div class="app-utility-item app-user-dropdown dropdown">
                  <a
                    ...
                    role="button"
                    aria-expanded="false"
                    ><img src="{{asset('backOffice/assets/images/user.png')}}" alt="user profile"
                  /></a>
                  <ul
                    class="dropdown-menu"
                ...
                <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                  ...
                  <span class="nav-icon">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                      <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.
                      004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"/>
                    </svg>
                  </span>
