...
<div class="container footer-top">
  <div class="row gy-4">
    ...
    <div class="col-lg-4 col-md-12 footer-newsletter">
     ...
     <p>acreditamos no poder da educação para impulsionar conquistas notáveis. Oferecemos programas abrangentes e especializados que vão além do convencional, preparando nossos alunos para os desafios dinâmicos do mercado de trabalho.</p>
    </div>
...
<script src="{{asset('site/assets/js/step.js')}}"></script>
<!-- Main JS File -->
