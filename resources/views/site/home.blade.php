...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Garimpos</a></h1>
      ...
      <a href="login_Admin" class="get-started-btn">Log Admin</a>
      <a href="login_aluno" class="get-started-btn"> Log Aluno</a>
  ...
  <section id="hero" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      ...
      <h2>A QuinGrace está a criar um grupo de Formadores<br> com os melhores alunos do Itel </h2>  
      <a href="rais" class="btn-get-started">Log Admin</a>
    </div>
  </section><!-- End Hero -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Be trane</h5>
      </div>
      <div class="modal-body">
      Tem certeza de que deseja ser um dos grandes Formadores da QuinGrace??
      </div>
      <div class="modal-footer">
      <button type="button" class="btn btn-primary"><a href="be_traner">Sim</a></button>
