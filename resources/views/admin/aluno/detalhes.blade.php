...
<div class="app-wrapper">
                    ...
                    <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                        ...
                        <div class="app-card-body px-4 w-100">
                            ...
                            <div class="item border-bottom py-3">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-auto">
                                        <div class="item-label"><strong>Genero</strong></div>
                                        <div class="item-data"> {{$aluno->genero}} º</div>
                                    </div>
                                    <!--//col-->
                                </div>
                                <!--//row-->
                            ...
                            <div class="item border-bottom py-3">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <div class="item-data"> {{$aluno->classe}} º</div>
                                    </div>
                                    <!--//col-->
                                </div>
                                <!--//row-->
                            ...
                            <div class="item border-bottom py-3">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <div class="item-data"> {{$aluno->email}}</div>
                                    </div>
                                    <!--//col-->
                                </div>
                                <!--//row-->
                            ...
                            <div class="item border-bottom py-3">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <div class="item-data"> {{$aluno->N_telemovel}}</div>
                                    </div>
                                    <!--//col-->
                                </div>
                                <!--//row-->
                    ...
                    <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                        <div class="app-card-header p-3 border-bottom-0">
                            <div class="row align-items-center gx-3">
                                ...
                                <!--//col-->
                                <div class="col-auto">
                                    <h4 class="app-card-title"> {{$aluno->processo}}</h4>
                                </div>
                                <div class="col-auto">
                                    <h4 class="app-card-title"> {{$aluno->identificador_fiscal}}</h4>
                                </div>
                                <!--//col-->
                            </div>
                            <!--//row-->
                        ...
                        <div class="app-card-body px-4 w-100">
                            ...
                            <div class="item border-bottom py-3">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-auto">
                                        <div class="item-label"><strong>Opções</strong></div>
                            ...
                            <!--//item-->
                            <div class="app-card-footer p-4 mt-auto">
                                <a class="btn btn-primary" href="{{ route('aluno.edit',['idUser'=>$aluno->id_usuario]) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
  ...
  5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z" />
                                ...
                                <a class="btn btn-danger" data-toggle="modal" data-target="#confirmDeleteModal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Você realmente deseja eliminar dados deste estudante?
                </div>
                <div class="modal-footer">
                    <a type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</a>
                    <a type="button" class="btn btn-danger" href="{{route('aluno.destroy',['id_user'=> $aluno->id_usuario, 'id_aluno'=>$aluno->id_aluno])}}">Eliminar</a>
                </div>
            </div>
        </div>
    </div>
