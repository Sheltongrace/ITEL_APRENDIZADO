                                ...
                                <table class="table app-table-hover mb-0 text-left">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="cell">
                                                @php
                                                $mensagem = explode('.',$contacto->mensagem);
                                                echo $mensagem[0];
                                                @endphp
                                            </td>
                                            <td class="cell"><a class="btn-sm app-btn-secondary" href="{{ route('admin.show',['id'=> $contacto->id]) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
