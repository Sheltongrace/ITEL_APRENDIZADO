...
<div class="app-wrapper">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <div>
                                                ...
                                                <td class="cell"> <a class="btn btn-primary" href="{{ route('curso.edit',['id'=>$cursos->id_curso]) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
  ...
  5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z" />
                                            ...
                                            <div>
                                                ...
                                                <td class="cell"> <a class="btn btn-danger" data-toggle="modal" data-target="#confirmDeleteModal{{$cursos->id_curso}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
   ...
   0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5m-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5M4.5 5.029l.5 8.5a.5.5 0 1 0
    ...
    5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5" />
                                            ...
                                            <div class="modal fade" id="confirmDeleteModal{{$cursos->id_curso}}" tabindex="-1" aria-labelledby="confirmDeleteModalLabel{{$cursos->id_curso}}" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a type="button" class="btn btn-danger" href="{{ route('cursosAdmin.destroy',['id'=>$cursos->id_curso]) }}">Eliminar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
