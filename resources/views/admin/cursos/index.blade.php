                        ...
                        <div class="app-card-body">
                            <div class="table-responsive">
                                <table class="table app-table-hover mb-0 text-left">
                                    <thead>
                                        <tr>
                                        <br> <th class="cell">Cursos</th>  <br>   <th class="cell">Editar</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        @if($cursos->nome_curso!="")
                                            <tr>
                                                <td class="cell">{{$cursos->nome_curso}}</td>  <div> </class> <td class="cell">  <a class="btn btn-primary" href="{{ route('curso.edit','1') }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
