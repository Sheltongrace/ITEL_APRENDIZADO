							    ...
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
											<tr>
												<td class="cell">
                                                    <img src="{{asset('backOffice/assets/images/profiles/profile-1.png')}}" alt="">
                                                </td>
											...
											<tr>
												<td class="cell">
                                                    <img src="{{asset('backOffice/assets/images/profiles/profile-2.png')}}" alt="">
                                                </td>
											...
											<tr>
												<td class="cell">
                                                    <img src="{{asset('backOffice/assets/images/profiles/profile-3.png')}}" alt="">
                                                </td>
											...
											<tr>
												<td class="cell">
                                                    <img src="{{asset('backOffice/assets/images/profiles/profile-4.png')}}" alt="">
                                                </td>
											...
											<tr>
												<td class="cell">
                                                    <img src="{{asset('backOffice/assets/images/profiles/profile-5.png')}}" alt="">
                                                </td>
											...
											<tr>
												<td class="cell">
                                                    <img src="{{asset('backOffice/assets/images/profiles/profile-6.png')}}" alt="">
                                                </td>
