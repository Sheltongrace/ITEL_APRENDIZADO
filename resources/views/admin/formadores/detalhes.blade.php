...
<div class="app-wrapper">
                ...
                <div class="col-12 col-lg-6">
                    <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                        ...
                        <div class="app-card-body px-4 w-100">
                            ...
                            <div class="app-card-footer p-4 mt-auto">
                                <a class="btn btn-primary" href="{{ route('formador.edit', ['id' => $professor->id_formador]) }}">
  ...
  5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z" />
                                ...
                                <a class="btn btn-danger" class="btn btn-danger" data-toggle="modal" data-target="#confirmDeleteModal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-danger" href="{{route('formador.destroy',['id_user'=> $professor->id_usuario, 'id_professor'=>$professor->id_formador])}}">Eliminar</a>
            </div>
        </div>
    </div>
</div>
