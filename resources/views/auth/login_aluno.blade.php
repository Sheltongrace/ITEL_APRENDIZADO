	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
					...
					<h2 class="auth-heading text-center mb-5">Entrar como aluno</h2>
			        <div class="auth-form-container text-start">
						<form class="auth-form login-form" action = "{{ route('auth.login') }}" method = "post">         
                            ...
                            <div class="email mb-3">
								...
								<input id="signin-email" name="signin-name" type="text" class="form-control signin-email" placeholder="fulanoexemplo" required="required">
							</div><!--//form-group-->
							<div class="password mb-3">
								<label class="form-label ps-2 mb-2 fw-semibold" for="signin-password">Numero de processo</label>
